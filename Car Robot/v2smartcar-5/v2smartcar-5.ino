...
int obstacle_status =B100000;
  ...
  if(ldiagonalscanval<distancelimit/0.70710){
    stop_Stop();
    alarm();
  ...
  head.write(80); //use 90 degrees if you are moving your servo through the whole 180 degrees
  delay(100);
  centerscanval = watch();
  if(centerscanval<distancelimit){
    stop_Stop();
  ...
  if(rdiagonalscanval<distancelimit/0.70710){
    stop_Stop();
    alarm();
